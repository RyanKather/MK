				...
				<div class="col-lg-8 col-md-12 col-sm-9 col-xs-12 form-box text-center">
					...
					<form action="registro.php" method ="POST">
						...
						<div class="form-input">
							...
							<input type="email" name="email"  placeholder="Endereço de E-mail" value= "<?php echo $email ?>" required>
						</div>
						<div class="form-input">
						...
						<div class="text-left mb-3">
							<button type="submit" name="submit" href= "sistema.php" class="btn">Registrar</button>
